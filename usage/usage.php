...
$url = 'http://rapiCan we .modgen.net';
$db = 'apitestdbname'; //DB name in Modgen environment
$key = 'someUniqueModgenApiKey';  //Hash for DB name generated by modgen environment
...
try {
    ...
    //$classApiClient->resetDatabase(true);

    //Item properties examples
    print_r($classApiClient->setItemProperty('extra_description', 'string'));  
    ...
    print_r(json_encode($classApiClient->deleteItemProperties(array('name', 'available', 'description', 'tags', 'price', 'added')))); 
    ...
    print_r($classApiClient->deleteItemValues('item-235',array('description','available'))); 
    ...
    print_r($classApiClient->getUserBasedRecommendation('o7oaysdasn8f7af',1)); 
    print_r($classApiClient->getUserBasedRecommendation('o7oaysdasn8f7af',1,array('diversity'=>1.0))); 
    print_r($classApiClient->getItemBasedRecommendation('item-234',10,array('diversity'=>0.2))); 
